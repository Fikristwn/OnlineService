...
import com.example.onlineservice.databinding.ActivityRegisterBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSubmit.setOnClickListener {
            ...
            if(!password.equals(konfirmasiPassword)){
                binding.etKonfirmasiPassword.error = "Password dankonfirmasi password tidak sama!"
                binding.etKonfirmasiPassword.requestFocus()
                return@setOnClickListener
            }
            val newUser = User(
                0.toString(), nama, tanggalLahir, jenisKelamin,
