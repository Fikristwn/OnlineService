package com.example.onlineservice.helpers
...
//Set user session for next 7 days --> 7 * 24 * 60 * 60 * 1000
    ...
    fun getUser(): User? {
        ...
        val user = User()
        user.id = mPreferences!!.getInt(KEY_ID, 0).toString()
...
private fun SharedPreferences.Editor.putInt(keyId: String, id: String) {
